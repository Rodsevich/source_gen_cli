...
//     addStep(new FileProcessor("test/source.dart",
//         defaultTemplate: "+{{name}}: {{age}}"));
//   }
// }
//
...
//     addStep(
//         new FileProcessor("test/source.dart", directives: [listDir, lastDir]));
//   }
// }
//
// FileProcessorDirective listDir = new FileProcessorDirective(
//     tag: "animals", processingFunction: sortingFunction);
// FileProcessorDirective lastDir = new FileProcessorDirective(
//     tag: "last-animal", processingFunction: replacingFunction);
// Function replacingFunction = (String existentString, Map variables) {
//   existentString.split('\n').map();
// };
// Function sortingFunction =
//     (String existentString, Map variables) => variables["name"];
//
// main() {
//   group("Additions", () {
//     File source;
...
//       Map variables = {
//         "last-animal": animals.last,
//         "animals": animals.map((String name) => {"name": name})
//       };
//     });
//   });
// }
